# El bucle for funciona tanto para tuplas como para conjuntos
...
# No valida para conjuntos
# Una manera muy interesante es la siguiente (no óptima)
# for num in range(len(animales)):
# print(animales[num])

# Forma correcta de recorrer una conjunto con su índice enumerate
